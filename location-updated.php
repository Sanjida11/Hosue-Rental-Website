    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($locationName_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="locationName" class="form-control" value="<?php echo $locationName; ?>">
            ...
            <div class="form-group <?php echo (!empty($areaName_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="areaName" class="form-control" value="<?php echo $areaName; ?>">
